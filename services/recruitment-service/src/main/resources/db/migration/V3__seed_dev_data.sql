...
INSERT INTO job_postings (
    ...
    positions_available, salary_min, salary_max, show_salary, is_remote, version
) VALUES
    -- Open positions
    ('11111111-1111-1111-1111-111111111101', 'JOB-001001', 'Senior Software Engineer',
     ...
     2, 650000.00, 850000.00, true, true, 0),
    ...
    ('11111111-1111-1111-1111-111111111102', 'JOB-001002', 'HR Business Partner',
     ...
     1, 450000.00, 600000.00, true, false, 0),
    ...
    ('11111111-1111-1111-1111-111111111103', 'JOB-001003', 'Financial Accountant',
     ...
     1, 500000.00, 700000.00, false, false, 0),
    ...
    ('11111111-1111-1111-1111-111111111104', 'JOB-001004', 'DevOps Engineer',
     ...
     1, 550000.00, 750000.00, true, true, 0),
    ...
    ('11111111-1111-1111-1111-111111111105', 'JOB-001005', 'Marketing Coordinator',
     ...
     1, 35000.00, 45000.00, true, false, 0),
    ...
    ('11111111-1111-1111-1111-111111111106', 'JOB-001006', 'Project Manager',
     ...
     'DRAFT', NULL, NULL,
     1, 600000.00, 800000.00, false, false, 0),
    ...
    ('11111111-1111-1111-1111-111111111107', 'JOB-001007', 'Junior Developer',
     ...
     1, 280000.00, 350000.00, true, true, 0)
...
INSERT INTO candidates (
    ...
    highest_qualification, field_of_study, skills, status, source, version
) VALUES
...
INSERT INTO applications (
    ...
    application_date, status, stage, screening_score, overall_rating, version
) VALUES
    ...
    ('33333333-3333-3333-3333-333333333301', 'APP-00100001',
     ...
     CURRENT_DATE - INTERVAL '8 days', 'SHORTLISTED', 'FIRST_INTERVIEW', 85, 4, 0),
    ...
    ('33333333-3333-3333-3333-333333333302', 'APP-00100002',
     ...
     CURRENT_DATE - INTERVAL '7 days', 'IN_REVIEW', 'SCREENING', 78, NULL, 0),
    ...
    ('33333333-3333-3333-3333-333333333303', 'APP-00100003',
     ...
     CURRENT_DATE - INTERVAL '4 days', 'NEW', 'NEW', NULL, NULL, 0),
    ...
    ('33333333-3333-3333-3333-333333333304', 'APP-00100004',
     ...
     CURRENT_DATE, 'NEW', 'NEW', NULL, NULL, 0),
    ...
    ('33333333-3333-3333-3333-333333333305', 'APP-00100005',
     ...
     CURRENT_DATE - INTERVAL '5 days', 'INTERVIEWING', 'PHONE_SCREEN', 70, 3, 0)
...
INSERT INTO interviews (
    ...
    interviewer_name, interviewer_email, status, version,
    candidate_notified, interviewer_notified, reminder_sent
) VALUES
    ...
    ('44444444-4444-4444-4444-444444444401', '33333333-3333-3333-3333-333333333301',
     ...
     'System Administrator', 'admin@testcompany.co.za', 'SCHEDULED', 0,
     false, false, false),
    ...
    ('44444444-4444-4444-4444-444444444402', '33333333-3333-3333-3333-333333333305',
     ...
     'System Administrator', 'admin@testcompany.co.za', 'CONFIRMED', 0,
     true, true, false)
